...
<div class="content">
  ...
  <div class="tabs">
    <ul>
      <li class="current"><a href="javascript:void(0)" class="current">商品列表</a></li>
    </ul>
  </div>
  <!--END 选项卡-->
  ...
  <!--END工具栏 BEGIN-->
   ...
   <!--搜索 BEGIN-->
<div class="search">
    <form action="<?php echo U('Admin/Product/ls');?>" method="post">
        <table width="100%">
            <td width="100">
              <input type="text" name="search" class="w300 mr10" placeholder="请输入商品名称进行查询" />
            </td>
...
<!--END 搜索--> 
  ...
  <!--列表 BEGIN-->
  <div class="list">
      <form action="<?php echo U('Admin/Product/del');?>" method="post" class="del-form">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <?php if(empty($list)): ?><tr>
              <td colspan="11" class="empty">暂无相关商品信息</td>
            </tr>
          <?php else: ?>
